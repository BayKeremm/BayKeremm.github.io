...
<div style="text-align: center; margin-top: 0.25rem;">
  ...
  <div style="margin: 0 auto; width: 84%;">
    <img src="figures/pedagoji_1.png" style="width: 100%; max-height: 500px; object-fit: contain; display: block;" />
  </div>
</div>
...
<div style="text-align: center; margin-top: 0.1rem;">
  ...
  <div style="margin: 0 auto; width: 86%;">
    <img src="figures/pedagoji_2.png" style="width: 100%; max-height: 480px; object-fit: contain; display: block;" />
  </div>
...
<div style="text-align: center; margin-top: 0.1rem;">
  ...
  <div style="margin: 0 auto; width: 78%;">
    <img src="figures/pedagoji_3.png" style="width: 100%; max-height: 480px; object-fit: contain; display: block;" />
  </div>
  <div style="display: inline-block; margin-top: 0.6rem; padding: 0.45rem 0.9rem; border-radius: 999px; background: #e0f2fe; color: #075985; font-weight: 700; box-shadow: 0 8px 20px rgba(15, 23, 42, 0.12);">
    $\text{cost}=1.6$
  </div>
...
<div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 0.75rem; width: 100%; margin: 1rem auto 0; align-items: start;">
  <div style="text-align: center;">
    <img src="figures/no_alpha.png" style="width: 100%; max-height: 280px; object-fit: contain;" />
    <div style="margin-top: 0.35rem; font-size: 0.75em;">No regularization</div>
  </div>
  <div style="text-align: center;">
    <img src="figures/alpha_1bucuk.png" style="width: 100%; max-height: 280px; object-fit: contain;" />
    <div style="margin-top: 0.35rem; font-size: 0.75em;">\(\alpha = 1.5\)</div>
  </div>
  <div style="text-align: center;">
    <img src="figures/alpha_bes.png" style="width: 100%; max-height: 280px; object-fit: contain;" />
    <div style="margin-top: 0.35rem; font-size: 0.75em;">\(\alpha = 5\)</div>
  </div>
</div>


No guarantees that extracted interface is 2-manifold.
